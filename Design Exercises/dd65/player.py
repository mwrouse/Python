...
class Player(games.Sprite, object):
    ...
    def tick(self):
        ...
        # Update damage sprite location and counter to remove from screen
...
class Cleric(Player):
    ...
    def __init__(self):
        super(Cleric, self).__init__("Player", classType="Cleric", image=Cleric.image, attackSound="sounds/cleric/attack.wav", specialSound="sounds/cleric/special.wav")
...
class Knight(Player):
    ...
    def __init__(self):
        super(Knight, self).__init__("Player", classType="Cleric", image=Knight.image, attackSound="sounds/knight/sword_swing.wav", specialSound="sounds/knight/sword_swing.wav")
...
class Thief(Player):
    ...
    def __init__(self):
        super(Thief, self).__init__("Player", classType="Thief", image=Thief.image, attackSound="sounds/thief/attack.wav", specialSound="sounds/thief/swoosh.wav")
        
    # Thief's Steal
    def special(self, enemy=None):
        if not self.attacking:
            self.attacking = True
            stolen = randint(1, 10)
            self.money += stolen
