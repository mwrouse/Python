"""
    Program......: challenge12_1.py
    Author.......: Michael Rouse
    Date.........: 3/26/14
    Description..: Add another type of space debris to the astrocrash program
"""
# Astrocrash08
...
class Vanguard(Wrapper):
    """ """
    image = games.load_image("vanguard.png")
    SPEED = 2

    def __init__(self, game, x, y):
        Asteroid.total += 1

        super(Vanguard, self).__init__(image=Vanguard.image, x=x, y=x,
                                       dx=random.choice([1, -1]) * Vanguard.SPEED,
                                       dy=random.choice([1, -1]) * Vanguard.SPEED)
