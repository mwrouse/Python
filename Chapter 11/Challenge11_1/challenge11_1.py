"""
    Program......: challenge11_1.py
    Author.......: Michael Rouse
    Date.........: 3/13/14
    Description..: Improve the Pizza Panic game by increase its difficulty as the game progresses
                   Think of different ways to do this
"""
from livewires import games, color
import random

# Create the game window and frame
games.init(screen_width=640, screen_height=480, fps=50)
score = games.Text(value=0, size=40, color=color.black, top=5, right=games.screen.width - 10)
...
class Pizza(games.Sprite):
    ...
    def __init__(self, x, y=90):
        ...
        if score.value >= 1500:
            ...
            Pizza.speed =  4
        elif score.value >= 600:
            Pizza.speed = 3
        elif score.value >= 400:
            Pizza.speed = 2.5
    ...
    def end_game(self):
        """ End the game. """
        end_message = games.Message(value="Game Over", size=90, color=color.red, x=(games.screen.width/2), y=(games.screen.height/2),
