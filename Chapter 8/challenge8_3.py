"""
    Program: challenge8_3.py
    Author: Michael Rouse
    Date: 12/12/13
    Description: Include a backdoor in the critter caretaker program to show all values exaclty
"""
#################################
#                               #
#   The secret option for the   #
#       backdoor is "5"         #
#                               #
#################################

from challenge8_3class import *
